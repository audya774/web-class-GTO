  ...
  return (
    <div className="z-1 relative h-auto lg:overflow-hidden">
      ...
      <div className="flex flex-col justify-center items-center">
        <img src="LineVertikal.svg" alt="LineVertikal" data-aos="fade-up" data-aos-duration="550" className="mb-2" />
        ...
        <div className="flex gap-[10.6rem] lg:gap-[23.1rem] relative top-[-10.44rem]" data-aos="fade-up" data-aos-duration="800">
          <img src="LineKananKiri.svg" alt="LineKananKiri" />
          <img src="LineKananKiri.svg" alt="LineKananKiri" />
