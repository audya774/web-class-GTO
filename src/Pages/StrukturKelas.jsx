...
const StrukturKelas = () => {
	...
	return (
		<div className="z-1 relative h-auto lg:overflow-hidden mb-6 bg-blue-500">
			{/* wali kelas */}
				...
				<div className=" absolute bottom-[15%] lg:bottom-[20%] " data-aos="fade-up" data-aos-duration="1000">
					<div className="flex justify-center items-center flex-col">
						...
						<div className="relative bottom-3">
							<BorderStruktur Jabatan="Anggota" Nama="Warga Kelas XII IPA 1" Width="150px" className="mb-2"/>
						</div>
					</div>
				</div>	
				{/* Kesehatan */}
