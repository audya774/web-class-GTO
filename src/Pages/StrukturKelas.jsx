  ...
  return (
    <div className="z-1 relative h-auto lg:overflow-hidden">
      ...
      <div className="flex flex-col justify-center items-center">
        <img src="LineVertikal.svg" alt="LineVertikal" data-aos="fade-up" data-aos-duration="550" className="mb-1,40" />
        ...
        <div className="flex gap-[10.6rem] relative top-[-18.38rem] lg:gap-[23.1rem]" data-aos="fade-up" data-aos-duration="1000">
          <img src="Circle.svg" alt="Circle" />
          <img src="Circle.svg" alt="Circle" />
