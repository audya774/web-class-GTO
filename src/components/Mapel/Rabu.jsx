const Rabu = () => {
    return (
        <>
            ...
            <div className="border-t-2 border-b-2 border-blue-500 bg-blue-500 text-white flex justify-between py-[0.50rem] w-72 px-3" data-aos="fade-up" data-aos-duration="800">
